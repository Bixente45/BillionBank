            ...
            if (Session["userId"] != null)
            {
                ...
                try
                {
                    ...
                    if (Convert.ToInt32(txtAmount.Text.Trim()) <= balanceAmount)
                    {
                        ...
                        cmd = new SqlCommand(@"Insert into [Transaction](SenderAccountId,ReceiverAccountId,Amount,TransactionType,Remarks) 
                                                values(@SenderAccountId,@ReceiverAccountId,@Amount,@TransactionType,@Remarks)", con, transaction);
...
//Description of the code:does transactions